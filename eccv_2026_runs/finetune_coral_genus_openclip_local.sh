...
RUN_NAME=${RUN_NAME:-"coral_genus_ft_openclip_local_$(date +%Y%m%d_%H%M%S)"}
LOG_DIR=${LOG_DIR:-"./logs_finetune/openclip_vith14_local"}
...
#   CONDA_BASE="/home/$USER/anaconda3" CONDA_ENV="pytoenv" bash eccv_2026_runs/finetune_coral_genus_openclip_local.sh
if [ -n "${CONDA_ENV}" ]; then
...
echo "========================================="
echo "Local OpenCLIP job finished at : $(date)"
echo "========================================="
