#!/bin/bash
#SBATCH --job-name=bioclip2-coral-genus-ft-openclip
#SBATCH --nodes=1
...
RUN_NAME=${RUN_NAME:-"coral_genus_ft_openclip_$(date +%Y%m%d_%H%M%S)"}
LOG_DIR=${LOG_DIR:-"./logs_finetune/openclip_vith14"}
...
echo "========================================="
echo "OpenCLIP job finished at : $(date)"
echo "========================================="
