...
RUN_NAME=${RUN_NAME:-"coral_genus_ft_bioclip_local_$(date +%Y%m%d_%H%M%S)"}
LOG_DIR=${LOG_DIR:-"./logs_finetune/bioclip2_local"}
...
#   CONDA_BASE="/home/$USER/anaconda3" CONDA_ENV="pytoenv" bash eccv_2026_runs/finetune_coral_genus_bioclip_local.sh
if [ -n "${CONDA_ENV}" ]; then
...
echo "========================================="
echo "Local BioCLIP job finished at : $(date)"
echo "========================================="
