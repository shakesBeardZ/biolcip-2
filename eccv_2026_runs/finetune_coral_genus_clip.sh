#!/bin/bash
#SBATCH --job-name=bioclip2-coral-genus-ft-clip
#SBATCH --nodes=1
...
RUN_NAME=${RUN_NAME:-"coral_genus_ft_clip_$(date +%Y%m%d_%H%M%S)"}
LOG_DIR=${LOG_DIR:-"./logs_finetune/clip_vitl14"}
...
echo "========================================="
echo "CLIP job finished at : $(date)"
echo "========================================="
